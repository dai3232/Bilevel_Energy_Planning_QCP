...
- A3 通过证据：`runs/20260721_080023_stage_A3_0fbd183e`；完整 KKT 为 18836，7 个日链为 589、590、589、590、590、590、590，既约系统为 4340，全局核心为 16，fixed_zero_map 为 422 项，6 项阻断性验收全部通过。
- 当前算法验证路线：A1 已完成第 1 日第 8–10 小时“3 小时人工闭合测试窗（仅算法测试）”的单次方向等价验证；A2 已完成第 14 日完整 24 小时单次方向等价验证；A3 已完成第 14–20 日 7 个正式日的串行单次方向等价验证；A4 尚未执行。
