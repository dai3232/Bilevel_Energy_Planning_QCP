...
5. `stage_0`、`stage_A1` 与 `stage_A2` 已通过，当前 `stage_A3` 为 `READY`；这只表示允许开展 A3，不表示 A3 已通过。

## 当前状态

- 已完成阶段：`stage_0 / PASS`、`stage_A1 / PASS`、`stage_A2 / PASS`
- 当前阶段：`stage_A3 / READY`（尚未执行、尚未通过）
...
- 当前算法验证路线：A1 已完成第 1 日第 8–10 小时“3 小时人工闭合测试窗（仅算法测试）”的单次方向等价验证；A2 已完成第 14 日完整 24 小时单次方向等价验证；A3 将验证第 14–20 日 7 天，最后才扩展到 365 天。
