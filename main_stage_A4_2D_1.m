...
indexA = rkkt.indexing.build_stage_a4_index( ...
    data,config,"RunId","A4_2D_1_CHAIN_A_INDEX");
indexB = rkkt.indexing.build_stage_a4_index( ...
    data,config,"RunId","A4_2D_1_CHAIN_B_INDEX");
abResult = rkkt.diagnostics.run_stage_a4_step_strategy_ab_diagnostic( ...
    data,indexA,indexB,config,"RetainRootCauseEvidence",true);
result = rkkt.diagnostics.run_stage_a4_small_step_root_cause_audit( ...
