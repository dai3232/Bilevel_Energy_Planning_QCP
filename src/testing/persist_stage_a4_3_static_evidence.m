...
arguments
    ...
    options.CommandText (1,1) string = ...
        "persist_stage_a4_3_static_evidence(...)"
end
...
scope = get_stage_a4_3_code_analyzer_scope(projectRoot,rebuiltClosure);
...
write_table_csv_17g(paths.analyzer,analyzer);
write_table_csv_17g(paths.analyzer_scope,scope);
write_table_csv_17g(paths.analyzer_advisories,advisories);
...
assert(compute_sha256_file(paths.stage_snapshot)== ...
    compute_sha256_file(fullfile(projectRoot,"CURRENT_STAGE.md")), ...
...
write_table_csv_17g(paths.summary,summary);
