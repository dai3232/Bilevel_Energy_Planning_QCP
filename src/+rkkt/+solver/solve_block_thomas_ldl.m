...
for t = 1:nHours
    ...
    if t == 1
        ...
        try
            [solvedTranspose,solveDiag] = rkkt.solver.solve_with_ldl_factor( ...
                factors{t-1}, block.E.', ...
    ...
    try
        factors{t} = rkkt.solver.factor_symmetric_ldl(schur{t},label, ...
...
for t = nHours:-1:1
    ...
    try
        [solutions{t},backSolveDiagnostics{t}] = rkkt.solver.solve_with_ldl_factor( ...
...
[stackedSolution,solutions,refinementDiagnostics] = ...
    rkkt.solver.refine_block_thomas_solution( ...
