...
try
    reduced = rkkt.solver.eliminate_inequality_directions(lin);
    layer = "hour_block_partition";
    partition = rkkt.solver.partition_recursive_system(lin,reduced, ...
    ...
    recovery = rkkt.solver.recover_recursive_direction(lin,partition,response,core);
    layer = "full_kkt_reinsertion";
    fullAssembly = rkkt.solver.assemble_full_kkt(lin);
