...
recovery=struct("stage_id","stage_B","milestone_id",contract.milestone_id, ...
    "linearization_identity",contract.identity,"direction",[deltaXi;deltaY;deltaL;deltaZ], ...
    "components",struct("xi",deltaXi,"y",deltaY,"l",deltaL,"z",deltaZ, ...
        "q",deltaXi(contract.q_global),"rho",deltaY(contract.y_duration), ...
