...
%
% rkkt.artifacts.save_mat_artifact(path, scalarStruct) saves each struct field as a named
% MAT variable. rkkt.artifacts.save_mat_artifact(path, name1, value1, ...) does the same for
