...
complementarityAuditPath = fullfile(projectRoot,"src","+rkkt","+diagnostics", ...
    "audit_stage_a4_complementarity_change.m");
a42dAuditPath = fullfile(projectRoot,"src","+rkkt","+diagnostics", ...
...
diagnosticRhsPath = fullfile(projectRoot,"src","+rkkt","+solver", ...
    "solve_stage_a_multiday_diagnostic_rhs_responses.m");
mandatoryPaths = [ ...
    entryPaths
    fullfile(projectRoot,"src","+rkkt","+diagnostics", ...
    ...
    fullfile(projectRoot,"src","+rkkt","+indexing","build_stage_a4_index.m")
    ...
    fullfile(projectRoot,"src","+rkkt","+model","initialize_stage_a4_state.m")
    fullfile(projectRoot,"src","+rkkt","+model", ...
        "initialize_stage_a_multiday_state.m")
    fullfile(projectRoot,"src","+rkkt","+model","build_stage_a4_linearization.m")
    fullfile(projectRoot,"src","+rkkt","+model", ...
        "build_stage_a_multiday_linearization.m")
    recursivePath
    directPath
    diagnosticRhsPath
    fullfile(projectRoot,"src","+rkkt","+solver", ...
        "compute_fraction_to_boundary_step.m")
    fullfile(projectRoot,"src","+rkkt","+solver","update_primal_dual_state.m")];
