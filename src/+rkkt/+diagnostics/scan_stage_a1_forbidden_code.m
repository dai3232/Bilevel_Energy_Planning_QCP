...
sourceRoots = [fullfile(projectRoot,"src","+rkkt","+model"); ...
    fullfile(projectRoot,"src","+rkkt","+indexing"); ...
    fullfile(projectRoot,"src","+rkkt","+solver"); ...
    fullfile(projectRoot,"src","+rkkt","+diagnostics"); ...
    fullfile(projectRoot,"src","+rkkt","+artifacts"); ...
    fullfile(projectRoot,"src","+rkkt","+reporting")];
files = strings(0,1);
...
for r = 1:numel(rules)
    ...
    if rules(r).id == "NO_PARALLEL_CALL"
        ...
        filesForRule = files(contains(lower(relativeFiles),"stage_a1") | ...
            startsWith(lower(relativeFiles),"src/+rkkt/+solver/") | ...
