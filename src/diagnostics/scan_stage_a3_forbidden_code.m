...
solverFiles=dir(fullfile(projectRoot,"src","solver","**","*.m"));
...
parallelCandidates=[string(fullfile(projectRoot,"main_stage_A3.m")); ...
    list_m_files(fullfile(projectRoot,"src","model"),"*stage_a3*.m"); ...
    list_m_files(fullfile(projectRoot,"src","indexing"),"*stage_a3*.m"); ...
    list_m_files(fullfile(projectRoot,"src","solver"),"*stage_a3*.m"); ...
    string(fullfile(projectRoot,"src","diagnostics", ...
        "run_stage_a3_direction_verification.m")); ...
    string(fullfile(projectRoot,"src","artifacts", ...
