...
equivalence = verify_stage_b2b_direction_equivalence( ...
...
reference=build_stage_b2b_multiday_linearization(state,data,index,config);
...
linPlus=build_stage_b2b_multiday_linearization(plus,data,index,config);
linMinus=build_stage_b2b_multiday_linearization(minus,data,index,config);
