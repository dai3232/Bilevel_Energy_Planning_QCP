...
%VERIFY_STAGE_A3_DIRECTION_EQUIVALENCE Audit canonical A3 directions.
...
assert(isequal(fullResult.linearization_identity,contract.identity) && ...
    ...
    "A3 directions do not share the linearization identity.");
...
assert(numel(fullDirection)==assembly.dimension && ...
    ...
    "stageA3:solver:DirectionDimension", ...
    "A3 directions must match the canonical KKT dimension.");
