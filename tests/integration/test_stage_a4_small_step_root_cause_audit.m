...
snapshot = struct( ...
    ...
    "model_tree",tree_inventory(fullfile(projectRoot,"src","+rkkt","+model"),true), ...
    "solver_tree",tree_inventory( ...
        fullfile(projectRoot,"src","+rkkt","+solver"),true), ...
...
if byteCount==0
    ...
    digest = lower(string(rkkt.data.compute_sha256_file(pathValue)));
end
end
