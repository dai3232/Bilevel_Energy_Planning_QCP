...
water = build_stage_b1_water_input_audit(data,runId);
[derivatives,~] = run_stage_b1_derivative_checks(data);
...
[hashes,hashPass] = verify_input_hashes(root);
...
environment = inspect_stage_b1_environment();
