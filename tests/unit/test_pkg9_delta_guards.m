...
root = testCase.TestData.root;
config = load_stage_a2_configuration(root);
data = load_project_data(root);
index = build_stage_a2_index(data,"RunId","PKG9_LDL_DELTA");
...
result = solve_block_thomas_ldl(partition, ...
...
for relative = ["main_stage_B_2C.m";"config/stage_B_2C.yaml"; ...
        "src/indexing/build_stage_b2c_index.m"; ...
        "src/solver/run_stage_b2c_full_ipm.m"; ...
        "src/solver/private/refine_stage_b2b_augmented_day_solution.m"; ...
        "src/solver/private/refine_stage_b2b_retained_chain_solution.m"].'
